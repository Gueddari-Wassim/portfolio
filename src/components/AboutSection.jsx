        ...
        <div className='container mx-auto max-w-5xl'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-12 items-center'>
                <div className='space-y-6'>
                    <h3 className='text-2xl font-semibold'>Passionate web/mobile Developer</h3>
                    ...
                    <div className='flex flex-col sm:flex-row gap-4 pt-4 justify-center'>
                        ...
                        <a href="/cv.pdf" download="Wassim_Gueddari_CV.pdf" className='px-6 py-2 rounded-full border border-primary text-primary hover:bg-primary/10 transition-colors duration-300'>
                            Download CV
                        </a>
                    </div>
                </div>
